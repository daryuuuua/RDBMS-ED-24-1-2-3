...
VALUES
(1, 'Олександр', 'Петров', '2024-08-09'),
(2, 'Марія','Іваненко', '2024-08-12'),
(3, 'Василь','Коваленко','2024-08-13');
...
(113, 'Прикладна математика', 'Спеціальнвсть прикладна математика...','240');
SELECT* 
FROM [dbo].[Students];
SELECT*
FROM[dbo].[Courses];
...
UPDATE Students SET Email='oleksandr.petrov@gmail.com' WHERE StudentId=1;
UPDATE Students SET Email='mariia.ivanenko@gmail.com' where StudentId=2;
UPDATE Students SET Email='vasyl.kovalenko@gmail.com' WHERE StudentId=3;
...
UPDATE Courses SET Department='Кафедра прикладної математики' WHERE CourseId=113;
