...
VALUES
(1, 'Олександра', 'Якимова', '2024-06-10'),
(2, 'Михайло','Ларіонов', '2024-07-11'),
(3, 'Юлія','Проходько','2024-08-12');
INSERT INTO Courses(CourseId, CourseName, CourseDescription, Credits)
VALUES
(073, 'Міжнародний менеджмент','Спеціальність міжнародний менеджмент...','240'),
(081, 'Право','Спеціальність право...','240'),
(241, 'Готельно-ресторанна справа', 'Спеціальнвсть готелно-ресторанна справа...','240');
...
UPDATE Students SET Email='oleksandra.yakimova@gmail.com' WHERE StudentId=1;
UPDATE Students SET Email='mihailo.larionov@gmail.com' where StudentId=2;
UPDATE Students SET Email='julia.prohodko@gmail.com' WHERE StudentId=3;
UPDATE Courses SET Department='Кафедра менеджменту' WHERE CourseId=073;
UPDATE Courses SET Department='Кафедра права' WHERE CourseId=081;
UPDATE Courses SET Department='Кафедра готельно-ресторанної справи та туризму' WHERE CourseId=241;
