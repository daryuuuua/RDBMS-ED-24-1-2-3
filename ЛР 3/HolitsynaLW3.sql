...
(1, 'Валерій', 'Зарівний', '2005-11-26'),

(2, 'Анна', 'Величко', '2007-07-12'),

(3, 'Андрій', 'Коваленко', '1999-09-07');

INSERT INTO Courses (RecordID, CourseName, CourseDescription, Credits)

VALUES

(1, '115', 'Основи виробничого менеджменту', '12'),

(2, '128', 'Фінанси', '25'),

(3, '359', 'Будівництво стійкої організації', '27');
...
ALTER TABLE Courses ADD Departmen NVARCHAR(200)
