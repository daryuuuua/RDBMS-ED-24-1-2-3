...
VALUES
(1, 'Артем', 'Ткач', '2024-05-21'),
(2, 'Андрій','Фомін', '2024-07-18'),
(3, 'Ілля','Туркевич','2024-06-01');
INSERT INTO Courses(CourseId, CourseName, CourseDescription, Credits)
VALUES
(121, 'Програмна інженерія','Факультет прикладної математики - це елітарність, фундаментальність комп’ютерної та математичної підготовки, гарантований успіх у науці, виробництві й бізнесі.','4'),
(073, 'Міжнародний менеджмент','Процес застосування управлінських концепцій та інструментів у багатокультурному середовищі та отриманні завдяки цьому найкращих результатів у досягненні своєї мети, додаткових переваг і заощадження часу.','5'),
(075, 'Маркетинг', 'визначення та керування бажаннями й потребами споживачів (покупців) для формування попиту на товари та послуги.','3');
...
UPDATE Students SET Email='artem_tkach@gmail.com' WHERE StudentId=1;
UPDATE Students SET Email='fomin_andrei@gmail.com' where StudentId=2;
UPDATE Students SET Email='turkevich_illia@gmail.com' WHERE StudentId=3;
UPDATE Courses SET Department='Кафедра програмної інженерії' WHERE CourseId=073;
UPDATE Courses SET Department='Кафедра міжнародного менеджменту' WHERE CourseId=081;
UPDATE Courses SET Department='Кафедра маркетингу' WHERE CourseId=241;
