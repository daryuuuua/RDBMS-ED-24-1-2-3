...
VALUES
(1, 'Максим', 'Абраменко', '2024-08-10'),
(2, 'Марія','Берлінська', '2024-08-11'),
(3, 'Анлрій','Коваленко','2024-08-13');

INSERT INTO Courses(CourseId, CourseName, CourseDescription, Credits)
VALUES
(081, 'Право','Спеціальність право...','240'),
(161, 'Журналістика','Спеціальність Журналістика...','240'),
...
UPDATE Students SET Email='maxim.abramenko@gmail.com' WHERE StudentId=1;
UPDATE Students SET Email='mariia.berlin@gmail.com' where StudentId=2;
UPDATE Students SET Email='andriy.kovalenko@gmail.com' WHERE StudentId=3;
UPDATE Courses SET Department='Кафедра права' WHERE CourseId=073;
UPDATE Courses SET Department='Кафедра Журналістики' WHERE CourseId=081;
UPDATE Courses SET Department='Кафедра менеджменту' WHERE CourseId=113;
