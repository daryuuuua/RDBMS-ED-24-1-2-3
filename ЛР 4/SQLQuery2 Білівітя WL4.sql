...
INSERT INTO Departments (DepartmentID) VALUES (1); -- Çàñòîñóºòüñÿ DEFAULT çíà÷åííÿ 'General'
...
INSERT INTO Professors (ProfessorID, FirstName, LastName, DepartmentID, Email) 
  VALUES (2, 'Jane', 'Doe', 1, 35, 'john.smith@university.com'); -- Öå âèêëè÷å ïîìèëêó ÷åðåç UNIQUE îáìåæåííÿ

  INSERT INTO Professors (ProfessorID, FirstName, LastName, DepartmentID, Email) 
  VALUES (3, 'Bob', 'Doe', 1, 17, 'bob@university.com'); -- Öå âèêëè÷å ïîìèëêó ÷åðåç CHECK îáìåæåííÿ
  ...
  INSERT INTO Assignments (AssignmentID, EmployeeID, DepartmentID) 
  VALUES (2, 999, 1); -- Öå âèêëè÷å ïîìèëêó ÷åðåç FOREIGN KEY îáìåæåííÿ
